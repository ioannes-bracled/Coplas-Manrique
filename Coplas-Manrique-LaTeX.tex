...
\usepackage{fontspec}
\usepackage[paperwidth=17.50cm,paperheight=25.00cm,top=1.65cm,inner=1.95cm,outer=1.65cm,bottom=2.50cm]{geometry}
\usepackage{tikz}
%
...
\edtext{aunque leemos y oímos}{\lemma{avn que leemos y oymos}\Afootnote{avn q\emph{ue} oymos y leemos {\delt}; aunque oymos y leimos \emph{ε}, {\im}}}\\
...
aquellas ropas \edtext{trepadas}{\Afootnote{japadas {\jm}; chapadas {\rl}, \emph{\textbf{ε}}, {\im}}}\\
