...
\usepackage{fontspec}
\usepackage[paperwidth=17.50cm,paperheight=25.00cm,top=2.20cm,inner=2.20cm,outer=1.65cm,bottom=1.95cm]{geometry}
\usepackage{polyglossia}
\setdefaultlanguage{spanish}
\setotherlanguage[variant=ancient]{greek}
\usepackage{editio-critica}
%
\title{\huge\textbf{COPLAS SOBRE LA MUERTE DE SU PADRE}}
\author{\huge\textsc{\textbf{Jorge Manrique}}}
\date{\vspace{60pt}\textsc{Edición crítica liminar}\\\fontsize{40}{11}\selectfont{\vfill\textbf{\LaTeX}}}
%
...
\vfill
\begin{flushright}
Edición y composición en XeLaTeX con el paquete Re-\\ledmac de \textsc{Maïaeul Rouquette} por \textsc{Ioannes Bracledus}.
\end{flushright}
\newpage
%
\pagenumbering{gobble}
...
%
Constituyen al aparato crítico el orden y rúbricas en los testimonios, el aparato de variantes y las explicaciones adicionales. El tipo de aparato de variantes es negativo. Luego de indicar el pasaje al que corresponde la variante --si se coloca \comillas{\textbf{\char"02016}}, indicará que aún continúa en el mismo pasaje--, se colocará la lección adoptada seguida por el signo \comillas{]} que encierra la lección adoptada, y tras el signo, las lecciones descartadas seguidas por su(s) sigla(s)\footnoteE{Irán en cursiva las siglas y se separarán con comas cada una.}, separada cada unidad por un \comillas{;}. Se eludirán variantes gráficas y de espacio. Las explicaciones contendrán argumentos en torno a las lecciones adoptadas, problemas respecto al estado del testimonio de base y plausibles interpretaciones.\par
\repage
%
\head{\textsc{Bibliografía}}
...
\end{center}
\pstart
\edtext{Y pues}{\lemma{y pues}\Afootnote{Pues si {\delt}}} vemos lo presente\\
...
%
\begin{center}
		\textbf{III}\footnoteA{\textbf{III} conpara {\eg}.}
\end{center}
\pstart
...
y más chicos,\\
\edtext{y llegados}{\Afootnote{alleguados {\jm}; allegados {\im}}}\footnoteE{\textcite{PérezPriego2017} sugiere que la lección \emph{alleguados}, probablemente a través de la contaminación de {\jm} al subarquetipo \emph{\textbf{β}}, habría generado la lección \emph{allegados}.}, son iguales,\\
los que bive\emph{n} por sus manos\\
y los ricos.\par
\pend
%
\begin{center}
	\textbf{IV}\footnoteA{\textbf{IV} ynuoca {\eg}; inuocaçion {\jm}; Inuocacion {\rl}.}
\end{center}
\pstart
...
%
\begin{center}
	\textbf{V}\footnoteA{\textbf{V} ap[lica] y [co]\emph{n}para \emph{ras.} {\eg}.}
	\end{center}
\pstart
...
andamos \edtext{q\emph{ua}ndo}{\Afootnote{mientra {\delt}; qua\emph{n}to {\hh}}} bivimos\\
...
%
\begin{center}
	\textbf{VI}\footnoteA{\textbf{VI} p\emph{r}osigue {\eg}.}
\end{center}
\pstart
...
%
\begin{center}
	\textbf{VII}\footnoteA{\textbf{VII} XXV en {\jm}; XIII en {\rl}.}
\end{center}
\pstart
...
%
\begin{center}
	\textbf{VIII}\footnoteA{\textbf{VIII} VII en \rl.}
\end{center}
\pstart
...
\edtext{y de ellas, por calidad}{\lemma{y dellas por calidad}\Afootnote{dellas por su calidad {\delt}, {\hh}, {\im}}},\\
en los más altos estados\\
desfallesçen.\par
\pend
%
\begin{center}
	\textbf{IX}\footnoteA{\textbf{IX} VIII en {\jm}, {\rl}.}
\end{center}
\pstart
...
%
\begin{center}
	\textbf{X}\footnoteA{\textbf{X} IX en {\jm}, {\rl}.}
\end{center}
\pstart
...
%
\begin{center}
	\textbf{XI}\footnoteA{\textbf{XI} X en {\jm}, {\rl}.}
\end{center}
\pstart
Los estados y \edtext{riqueza}{\Afootnote{riquezas {\delt}, {\hh}}}\\
...
que \edtext{rebuelve}{\lemma{rebuelue}\Afootnote{rebueluen {\delt}}} co\emph{n} su rueda\\
presurosa,\\
...
%
\begin{center}
	\textbf{XII}\footnoteA{\textbf{XII} XI en {\jm}, {\rl}.}
\end{center}
\pstart
\edtext{Y pues}{\lemma{y pues}\Afootnote{pero {\gamm}, {\im}}} digo que \edtext{acompañen}{\Afootnote{aco\emph{n}pañe {\eg}}}\\
...
como sueño.\par
\edtext{Y}{\lemma{y}\Afootnote{q\emph{ue} {\hh}}} los \edtext{plazeres}{\Afootnote{deleytes {\gamm}, {\im}}} de acá\\
...
%
\begin{center}
	\textbf{XIII}\footnoteA{\textbf{XIII} XII en {\jm}, {\rl}.}
\end{center}
\pstart
...
%
\begin{center}
	\textbf{XIV}\footnoteA{\textbf{XIV} XXVI en {\jm}.}
\end{center}
\pstart
Estos reyes poderosos\\
que \edtext{vemos}{\lemma{veemos}\Afootnote{leemos {\jm}; vedes {\etag}}} por escrituras\\
ya pasadas,\\
...
%
\begin{center}
	\textbf{XV}\footnoteA{\textbf{XV} XXVII en {\jm}.}
\end{center}
\pstart
...
\edtext{aunque leemos y oímos}{\lemma{avn que leemos y oymos}\Afootnote{avn q\emph{ue} oymos y leemos {\delt}; aunque oymos y leimos {\etag}, {\im}}}\\
...
%
\begin{center}
	\textbf{XVI}\footnoteA{\textbf{XVI} XXVIII en {\jm}.}
\end{center}
\pstart
...
como \edtext{traxiero\emph{n}}{\Afootnote{truxieron {\delt}, {\mn}}}?\par
Las justas y los torneos,\edtext{}{\linenum{|||||189}\Afootnote[nosep]{\hspace*{-0.4em}\textbf{/190}--\textbf{192} \emph{transp.} {\rl}}}\\
...
%
\begin{center}
	\textbf{XVII}\footnoteA{\textbf{XVII} XXIX en {\jm}.}
\end{center}
\pstart
...
aquellas ropas \edtext{trepadas}{\Afootnote{japadas {\jm}; chapadas {\rl}, {\etag}, {\im}}}\\
que \edtext{traían}{\lemma{trayan}\Afootnote{vestian {\etag}}}?\par
\pend
%
\begin{center}
	\textbf{XVIII}\footnoteA{\textbf{XVIII} XXX en {\jm}.}
\end{center}
\pstart
...
%
\begin{center}
	\textbf{XIX}\footnoteA{\textbf{XIX} XXXI en {\jm}.}
\end{center}
\pstart
...
%
\begin{center}
	\textbf{XX}\footnoteA{\textbf{XX} XXXII en {\jm}.}
\end{center}
\pstart
...
%
\begin{center}
	\textbf{XXI}\footnoteA{\textbf{XXI} XXXIII en {\jm}.}
\end{center}
\pstart
...
%
\begin{center}
	\textbf{XXII}\footnoteA{\textbf{XXII} XXXIV en {\jm}.}
\end{center}
\pstart
...
%
\begin{center}
	\textbf{XXIII}\footnoteA{\textbf{XXIII} XXXV en {\jm}.}
\end{center}
\pstart
...
%
\begin{center}
	\textbf{XXIV}\footnoteA{\textbf{XXIV} XXXVI en {\jm}.}
\end{center}
\pstart
...
\edtext{y}{\Afootnote{o {\gamm}, {\im}}} qualquier otro reparo\\
¿qué aprovecha?\\
\edtext{Q\emph{ua}ndo}{\lemma{q\emph{ua}ndo}\Afootnote{que si {\etag}, {\im}}} tú vienes irada,\\
todo lo \edtext{pasas}{\Afootnote{lleuas {\hh}}} \edtext{de claro}{\Afootnote{de claro en claro {\jm}}}\\
co\emph{n} tu flecha.\par
\pend
%
\begin{center}
	\textbf{XXV}\footnoteA{\textbf{XXV} XIII en {\jm}. || dirige la fabla al maestre do\emph{n} rodrigo su padre {\eg}; ffabla del maestre do\emph{n} rr\emph{odri}go ma\emph{n}riq\emph{ue} {\hh}.}
\end{center}
\pstart
...
%
\begin{center}
	\textbf{XXVI}\footnoteA{\textbf{XXVI} XIV en {\jm}.}
\end{center}
\pstart
...
%
\begin{center}
	\textbf{XXVII}\footnoteA{\textbf{XXVII} XV en {\jm}. \textbf{||} conpara {\eg}.}
\end{center}
\pstart
...
%
\begin{center}
	\textbf{XXVIII}\footnoteA{\textbf{[XXVIII]} XXVI en {\jm}. \textbf{||} prosigue {\eg}.}
\end{center}
\pstart
...
\edtext{y}{\Afootnote{del {\delt}, {\mn}, {\im}; y bue\emph{n} {\hh}}} senblante;\\
\edtext{Adrïano}{\lemma{adriano}\Afootnote{adriapo {\jm}}} en eloq\emph{ue}nçia,\\
...
%
\begin{center}
	\textbf{XXIX}\footnoteA{\textbf{XXIX} XVII en {\jm}; XXX en {\hh}.}
\end{center}
\pstart
...
%
\begin{center}
	\textbf{XXX}\footnoteA{\textbf{XXX} XVIII en {\jm}; XXIX en {\hh}.}
\end{center}
\pstart
...
fizo \edtext{en estas dichas guerras}{\Afootnote{en la dicha guerra {\jm}; en esta misma guerra {\rl}; en esta dicha guerra {\etag}, {\im}}}\\
que fazía,\\
fizo tratos ta\emph{n} ho\emph{n}rrosos\\
que le diero\emph{n} \edtext{aún}{\lemma{avn}\Afootnote{muy {\im}}} más \edtext{t\emph{ie}rras}{\Afootnote{tierra {\gamm}, {\im}}}\\
\edtext{que}{\Afootnote{quel {\jm}}} tenía.\par
\pend
\repage
%
\begin{center}
	\textbf{XXXI}\footnoteA{\textbf{XXXI} XIX en {\jm}.}
\end{center}
\pstart
\edtext{Y}{\lemma{y}\Afootnote{\emph{om.} {\gamm}, {\im}}} estas sus viejas istorias\\
...
%
\begin{center}
	\textbf{XXXII}\footnoteA{\textbf{XXXII} XX en {\jm}.}
\end{center}
\pstart
...
%
\begin{center}
	\textbf{XXXIII}\footnoteA{\textbf{XXXIII} XXI en {\jm}.}
\end{center}
\pstart
Después \edtext{que puso}{\Afootnote{de puesta {\eg}, {\delt}}} la vida\\
...
por la fama,\\
\edtext{fazedla de la virtud}{\Afootnote{esfuercese la virtud {\delt}, {\mn}, {\im}; esforçad vuestra virtud {\hh}}}\\
...
%
\begin{center}
	\textbf{XXXV}\footnoteA{\textbf{XXXV} XXIII en {\jm}.}
\end{center}
\pstart
...
\edtext{ni}{\Afootnote{\emph{om.} {\im}}} \edtext{duradera}{\Afootnote{verdadera {\delt}, {\mn}, {\im}}},\\
...
%
\begin{center}
	\textbf{XXXVI}\footnoteA{\textbf{XXXVI} XXIV en {\jm}.}
\end{center}
\pstart
...
infernales;\par
\edtext{que los}{\Afootnote{mas los {\delt}, {\mn}}} buenos religiosos\\
...
\edtext{que la vida verdadera}{\Afootnote{estotra vida tercera {\delt}, {\mn}, {\im}}}\\                                                                           
\edtext{cobraréis}{\lemma{cobrareys}\Afootnote{ganareys {\delt}, {\mn}, {\im}}}.»\par
\pend
%
\begin{center}
	\textbf{XXXVIII}\footnoteA{\textbf{XXXVIII} rresponde don rrodrigo manrrique a la muerte {\eg}; Respuesta del maestre {\jm}; Reza a la muerte {\rl}; Respondel Maestre {\mn}, {\im}.}
\end{center}
\pstart
...
%
\begin{center}
	\textbf{XXXIX}\footnoteA{\textbf{XXXIX} oraçion que fizo el maestre {\eg}; Oracion {\jm}, {\rl}, {\im}; Oracion quel Maestre face á Dios {\mn}.}
\end{center}
\pstart
...
Tú, \edtext{que los}{\Afootnote{que tan {\delt}, {\mn}, {\im}}} gra\emph{n}des torme\emph{n}tos\\
...
%
\begin{center}
    \textbf{XL}\footnoteA{\textbf{XL} fin {\eg}, {\rl}, {\mn}; Torna el actor y faze fin {\jm}.}
\end{center}
\pstart
