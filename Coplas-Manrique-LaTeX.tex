...
\vfill
\begin{flushright}
Edición y composición en XeLaTeX con el paquete Re-\\ledmac de \textsc{Maïaeul Rouquette} por \textsc{Ioannes Bracledes}.
\end{flushright}
\newpage
%
\tableofcontents
...
\vfill
%
\section*{\textsc{Criterios de edición}}
...
\newpage
%
\section*{\raggedleft\textsc{Texto y aparato críticos}}
\addcontentsline{toc}{section}{\textsc{Texto y aparato críticos}}
\newpage
%
\section*{\raggedleft\textsc{Conspectus siglorum}}
\addcontentsline{toc}{section}{\textsc{Conspectus siglorum}}
%
\subsection*{\normalsize\textsc{Sigla testimoniorum}}
\addcontentsline{toc}{subsection}{\textsc{Sigla testimoniorum}}
\vspace*{-2.5pt}
...
%
\begin{center}
	\textbf{[VIII]}\footnoteA{\textbf{[VIII]} VII en \emph{86*JM}.}
\end{center}
\pstart
